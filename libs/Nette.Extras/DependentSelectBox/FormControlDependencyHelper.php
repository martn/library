...
class FormControlDependencyHelper extends NObject {
...
// <editor-fold defaultstate="collapsed" desc="constructor">
	 ...
	 */
	function __construct(NFormControl $control, $controlClass = "dependentControl") {
		$this->control = $control;
		$this->controlClass = $controlClass;
		$this->buttonPosition = self::$defaultButtonPosition;
		if(!($control->getForm() instanceof NFormContainer))
...
// <editor-fold defaultstate="collapsed" desc="tools & helpers">
	...
	public function createButton() {
		...
		$container = $this->control->lookup("Nette\Forms\NFormContainer");

		$this->button = new NSubmitButton($this->buttonText);
