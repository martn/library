(function($){
	...
	uploadify.uploadify({
		...
		buttonImg: {!=NEnvironment::expand("%baseUri%images/MultipleFileUpload/uploadify/uploadifyButton.png")|escapeJS},
		uploader: {!=NEnvironment::expand("%baseUri%swf/MultipleFileUpload/uploadify/uploadify.allglyphs.swf")|escapeJS},
		cancelImg: {!=NEnvironment::expand("%baseUri%images/MultipleFileUpload/uploadify/cancel.png")|escapeJS},
