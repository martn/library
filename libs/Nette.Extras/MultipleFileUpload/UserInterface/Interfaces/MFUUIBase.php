 ...
 * @author Honza
 */
abstract class MFUUIBase extends NObject implements MFUUIInterface {
	...
	protected function createTemplate($file = null)
	{
		...
		$template->registerHelperLoader('Nette\Templates\NTemplateHelpers::loader');
