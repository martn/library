...
class DatePicker extends NFormControl {
    ...
    /**
     * adds DatePicker instance to NFormContainer
     * @param NFormContainer $container
     * @param <type> $name
     * @param <type> $label
     ...
     * @return <type>
     */
    static function addDatePicker(NFormContainer $container, $name, $label = NULL, DateTime $minDate = NULL, DateTime $maxDate = NULL) {
        return $container[$name] = new DatePicker($label, $minDate, $maxDate);
    }   
    ...
    public function getControl() {
        ...
        if ($this->minDate)
            $control->min = $this->minDate->format(self::W3C_DATE_FORMAT);
        if ($this->maxDate)
            $control->max = $this->maxDate->format(self::W3C_DATE_FORMAT);
        if ($this->value)
