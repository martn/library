<?php //netteCache[01]000252a:2:{s:4:"time";s:21:"0.34482700 1295917678";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:96:"C:\Users\Martin\Web\library\root\www/../app/FrontModule/templates/Sections/../@doublepanel.phtml";i:2;i:1295196004;}}}?><?php
// file …/FrontModule/templates/Sections/../@doublepanel.phtml
//

$_cb = NLatteMacros::initRuntime($template, true, 'c755996849'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb0ef326f9ad_content')) { function _cbb0ef326f9ad_content($_args) { extract($_args)
...
// block right
//
if (!function_exists($_cb->blocks['right'][] = '_cbbed692efcf5_right')) { function _cbbed692efcf5_right($_args) { extract($_args)
;if (NSnippetHelper::$outputAllowed) { } 
}}
