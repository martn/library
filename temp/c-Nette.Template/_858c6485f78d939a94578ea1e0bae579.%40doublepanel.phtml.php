<?php //netteCache[01]000249a:2:{s:4:"time";s:21:"0.59997000 1295942241";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:93:"C:\Users\Martin\Web\library\root\www/../app/FrontModule/templates/Menus/../@doublepanel.phtml";i:2;i:1295196004;}}}?><?php
// file …/FrontModule/templates/Menus/../@doublepanel.phtml
//

$_cb = NLatteMacros::initRuntime($template, true, '1db83a392a'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbed2d4b7fd2_content')) { function _cbbed2d4b7fd2_content($_args) { extract($_args)
...
// block right
//
if (!function_exists($_cb->blocks['right'][] = '_cbbc45c7940d2_right')) { function _cbbc45c7940d2_right($_args) { extract($_args)
;if (NSnippetHelper::$outputAllowed) { } 
}}
