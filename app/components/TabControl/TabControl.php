 ...
 */
class TabControl extends NControl {
	...
	public function  __construct($parent, $name) {
		...
		$this->tabContainer = NHtml::el("div")->class("tabs");
	...
	function saveTabsOrder(array $order) {
		$session = NEnvironment::getSession("TabControl\\".$this->getUniqueId());
		$session["order"] = $order;
	}
	 ...
	 * @return bool
	 */
	function isSignalReceiver(NPresenterComponent $component,$signal) {
