 ...
 */
class HeaderControl extends NControl {
	...
	public function renderBegin() {
		...
		if ($this->docType == self::XHTML_1_STRICT &&
			...
			NEnvironment::getHttpResponse()->setContentType($contentType, 'utf-8');
		}
		...
		$metaLanguage = NHtml::el('meta')->content($this->language);
		$metaLanguage->attrs['http-equiv'] = 'Content-Language';
		echo $metaLanguage . "\n";

		$metaContentType = NHtml::el('meta')->content($contentType);
